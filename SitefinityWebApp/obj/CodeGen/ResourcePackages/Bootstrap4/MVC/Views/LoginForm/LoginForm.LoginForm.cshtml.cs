...
WriteAttributeTo(__razor_helper_writer, "id", Tuple.Create(" id=\'", 6084), Tuple.Create("\'", 6111)

#line 145 "..\..\ResourcePackages\Bootstrap4\MVC\Views\LoginForm\LoginForm.LoginForm.cshtml"
, Tuple.Create(Tuple.Create("", 6089), Tuple.Create<System.Object, System.Int32>(Html.UniqueId(descId)
...
Write(Html.Script("//cdnjs.cloudflare.com/ajax/libs/jquery-validate/1.19.5/jquery.validate.js", "top", true, false, new List<KeyValuePair<string, string>>() { HtmlConstants.CrossOriginHtmlAttribute }));
...
WriteAttribute("class", Tuple.Create(" class=\"", 1485), Tuple.Create("\"", 1502)
            
            #line 30 "..\..\ResourcePackages\Bootstrap4\MVC\Views\LoginForm\LoginForm.LoginForm.cshtml"
, Tuple.Create(Tuple.Create("", 1493), Tuple.Create<System.Object, System.Int32>(rowClass
...
WriteAttribute("class", Tuple.Create(" class=\"", 1522), Tuple.Create("\"", 1539)
            
            #line 31 "..\..\ResourcePackages\Bootstrap4\MVC\Views\LoginForm\LoginForm.LoginForm.cshtml"
, Tuple.Create(Tuple.Create("", 1530), Tuple.Create<System.Object, System.Int32>(colClass
...
WriteAttribute("class", Tuple.Create(" class=\"", 3082), Tuple.Create("\"", 3123)
, Tuple.Create(Tuple.Create("", 3090), Tuple.Create("text-lg-right", 3090), true)
, Tuple.Create(Tuple.Create(" ", 3103), Tuple.Create("pr-4", 3104), true)
            
            #line 59 "..\..\ResourcePackages\Bootstrap4\MVC\Views\LoginForm\LoginForm.LoginForm.cshtml"
, Tuple.Create(Tuple.Create(" ", 3108), Tuple.Create<System.Object, System.Int32>(isPulledRight
...
WriteAttribute("href", Tuple.Create(" href=\"", 3852), Tuple.Create("\"", 3881)
            
            #line 76 "..\..\ResourcePackages\Bootstrap4\MVC\Views\LoginForm\LoginForm.LoginForm.cshtml"
, Tuple.Create(Tuple.Create("", 3859), Tuple.Create<System.Object, System.Int32>(Model.RegisterPageUrl
